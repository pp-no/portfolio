...
export default function FlowSection() {
  const steps = [
    { title: "お申し込み", desc: "フォーム送信後、担当より1営業日以内にご連絡します。", img: "https://placehold.co/400x250?text=Flow+1" },
    { title: "初期設定", desc: "要件をヒアリングし、最短当日で環境をご用意。", img: "https://placehold.co/400x250?text=Flow+2" },
    { title: "運用開始", desc: "チュートリアル実施後、すぐに現場でご利用いただけます。", img: "https://placehold.co/400x250?text=Flow+3" },
  ];
  return (
