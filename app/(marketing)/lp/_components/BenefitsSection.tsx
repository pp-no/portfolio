...
export default function BenefitsSection() {
	const cards = [
		{
			title: 'コスト最適化',
			desc: '必要な機能に絞った料金で無駄を削減。',
			img: 'https://placehold.co/400x250?text=Benefit+1',
		},
		{
			title: 'スピード導入',
			desc: '最短当日から運用開始できる初期セットアップ。',
			img: 'https://placehold.co/400x250?text=Benefit+2',
		},
		{
			title: '拡張性',
			desc: 'API連携で業務に合わせて柔軟に拡張可能。',
			img: 'https://placehold.co/400x250?text=Benefit+3',
		},
	];
	return (
